import SpaAndWellnessManagerPhoto from '../../assets/Team/spa_wellness_manager.jpg'

export default function SpaAndWellnessManager() {
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 py-16 pt-14 pb-6 lg:py-16 lg:pt-16 lg:pb-4">
        ...
        <figure className="grid grid-cols-1 items-center gap-x-6 gap-y-4 lg:gap-x-10">
          <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
            <blockquote className="text-slate-900">
              <h2 className="text-4xl sm:text-4xl lg:text-5xl font-semibold text-teal-600">
                Inspired by Nature, Guided by Hand
              </h2>
              <p className="mt-4 text-lg/8 text-slate-700">
                Guided by our Spa & Wellness Manager, Ma Thida Win, our philosophy is all about balance. We combine serene, traditional Shan therapies for restoration with a modern fitness center for recharging, helping you leave feeling your absolute best.
              </p>
            </blockquote>
          </div>
          <div className="col-end-1 w-16 lg:row-span-4 lg:w-72">
            <img
              alt="Spa & Wellness Manager Ma Thida Win"
              src={SpaAndWellnessManagerPhoto}
              loading="lazy"
              decoding="async"
              fetchPriority="low"
          ...
          <figcaption className="text-base lg:col-start-1 lg:row-start-3">
            <div className="font-semibold text-teal-600">Ma Thida Win</div>
            <div className="mt-1">
