...
import SpaAndWellnessCenterImg from '../../assets/Spa&WellnessCenter/spa_wellness_banner_img.jpg'

interface SpaAndWellnessCenterBannerProps {
    onNavigate?: (page: string) => void
}

export default function SpaAndWellnessCenterBanner({ onNavigate }: SpaAndWellnessCenterBannerProps) {
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center px-4 sm:px-6 pt-32 pb-20 sm:pt-40 sm:pb-32 lg:pt-48 lg:pb-40 text-center lg:px-8">
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/90 leading-relaxed max-w-2xl mx-auto">
            Step into a world of tranquility and revitalization. Our wellness sanctuary is dedicated to soothing your body, calming your mind, and renewing your spirit amidst the serene beauty of Kalaw.
          </p>
        </div>
      </div>
    </div>
