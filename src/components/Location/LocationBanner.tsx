...
import LocationImg from '../../assets/Location/location_banner_img.jpg'

interface LocationBannerProps {
    onNavigate?: (page: string) => void
}

export default function LocationBanner({ onNavigate }: LocationBannerProps) {
    const breadcrumbPages = [
        { name: 'Location', href: '#location', current: true }
    ]
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center px-4 sm:px-6 pt-32 pb-20 sm:pt-40 sm:pb-32 lg:pt-48 lg:pb-40 text-center lg:px-8">
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/90 leading-relaxed max-w-2xl mx-auto">
            Nestled within the charming town of Kalaw, The Evergreen Hill is your gateway to the legendary Shan Highlands. Explore breathtaking landscapes from our serene and private sanctuary.
          </p>
        </div>
      </div>
    </div>
