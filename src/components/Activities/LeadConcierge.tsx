import LeadConciergePhoto from '../../assets/Team/lead_concierge.jpg'
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 py-16 pt-14 pb-6 lg:py-16 lg:pt-16 lg:pb-4">
        ...
        <figure className="grid grid-cols-1 items-center gap-x-6 gap-y-4 lg:gap-x-10">
          <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
            <blockquote className="text-slate-900">
              ...
              <p className="mt-4 text-lg/8 text-slate-700">
                Think of me as your personal guide to the heart of the Shan highlands. My passion is to help you discover Kalaw's hidden gems, from the most scenic treks to authentic local experiences.
              </p>
            </blockquote>
          </div>
          <div className="col-end-1 w-16 lg:row-span-4 lg:w-72">
            <img
              alt="Lead Concierge May Thet Hnin"
              src={LeadConciergePhoto}
              loading="lazy"
              decoding="async"
              fetchPriority="low"
          ...
          <figcaption className="text-base lg:col-start-1 lg:row-start-3">
            <div className="font-semibold text-teal-700">May Thet Hnin</div>
            <div className="mt-1">
