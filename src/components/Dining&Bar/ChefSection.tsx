import HeadChefPhoto from '../../assets/Team/head_chef.jpg'
          ...
          <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
            <blockquote className="text-slate-900">
              ...
              <p className="mt-4 text-lg/8 text-slate-700">
                Led by our renowned Head Chef, U Sai Myo, our culinary philosophy is simple: celebrate the rich bounty of the Shan region. We partner with local farmers to source the freshest seasonal ingredients, ensuring every dish is a true expression of Kalaw's vibrant flavors.
              </p>
            </blockquote>
          </div>
