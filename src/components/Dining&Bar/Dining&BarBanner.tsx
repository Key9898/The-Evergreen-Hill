...
export default function DiningBarBanner({ onNavigate }: DiningBarBannerProps) {
    const breadcrumbPages = [
        ...
        { name: 'Dining & Bar', href: '#DiningAndBar', current: true }  
    ]
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center px-4 sm:px-6 pt-32 pb-20 sm:pt-40 sm:pb-32 lg:pt-48 lg:pb-40 text-center lg:px-8">
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/90 leading-relaxed max-w-2xl mx-auto">
            Experience the authentic flavors of the Shan Highlands, reimagined with modern culinary artistry and served against a backdrop of breathtaking mountain views.
          </p>
        </div>
      </div>
    </div>
