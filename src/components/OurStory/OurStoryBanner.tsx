...
import OurStoryImg from '../../assets/OurStory/our_story_banner_img.jpg'
...
export default function OurStoryBanner({ onNavigate }: OurStoryBannerProps) {
    const breadcrumbPages = [
        { name: 'Our Story', href: '#ourStory', current: true }
    ]
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center px-4 sm:px-6 pt-32 pb-20 sm:pt-40 sm:pb-32 lg:pt-48 lg:pb-40 text-center lg:px-8">
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/90 leading-relaxed max-w-2xl mx-auto">
            Every great sanctuary begins with a story. Discover the passion, heritage, and vision that brought The Evergreen Hill to life in the serene landscape of Kalaw.
          </p>
        </div>
      </div>
    </div>
